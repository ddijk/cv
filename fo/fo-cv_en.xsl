	...
	<xsl:template match="ervaringen">
		...
		<fo:table table-layout="fixed" width="100%" border-collapse="separate">
			...
			<fo:table-body>
				...
				<fo:table-row>
					<fo:table-cell >
						<fo:block>Operating Systems:</fo:block>
					</fo:table-cell>
					<fo:table-cell >
						<fo:block>
			...
			<fo:table table-layout="fixed" width="100%" border-collapse="separate">
				...
				<fo:table-body>
					...
					<fo:table-row>
						<fo:table-cell >
							<fo:block>
								<xsl:text>Place of residence:</xsl:text>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell >
							<fo:block>
