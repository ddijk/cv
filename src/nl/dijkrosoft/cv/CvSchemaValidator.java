...
public class CvSchemaValidator {
    ...
    public static void main(String[] args) {
        try {
            ...
            JAXBContext jc = JAXBContext.newInstance("nl.dijkrosoft.cv.jaxb");
            ...
            try {
                Schema schema = sf.newSchema(new File("cv.xsd"));
                u.setSchema(schema);
                u.setEventHandler(
...
//                                return true;
				...
				// ik wil validatefouten een fout laten geven
                                return false;
                            }
                        });
...
//            System.out.println( "NOTE: This sample is working correctly if you see validation errors!!");
            ...
            Object poe = u.unmarshal(new File("cv.xml"));
   ...
   //         System.out.println("");
    //        System.out.println("Still able to marshal invalid document");
	    ...
	    System.out.println("\nSchema validatie SUCCESVOL");
        } catch (UnmarshalException ue) {
            // The JAXB specification does not mandate how the JAXB provider
            // must behave when attempting to unmarshal invalid XML data.  In
            // those cases, the JAXB provider is allowed to terminate the 
            // call to unmarshal with an UnmarshalException.
            System.out.println("Caught UnmarshalException. " + ue);
